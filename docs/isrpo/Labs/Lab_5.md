# Лабораторная работа №5. Использование систем сборки Make и CMake
...
7. Ответы на вопросы из пункта 4.1.
8. Заключение, в котором подведены итоги работы и сформулированы основные выводы.
...
## Заключение:
В ходе данной лабораторной работы вы освоили основы использования систем сборки Make и CMake, научились создавать необходимые файлы конфигурации и строить простые проекты. Вы также познакомились с различиями и особенностями этих систем, что позволит вам в будущем выбирать наиболее подходящий инструмент для ваших задач.